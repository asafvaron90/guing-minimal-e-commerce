...
import type { FavouriteButtonSize } from './TesttCardd';
import type { FavouriteButtonState } from './TesttCardd';
import { FIGMA_ICON_HEART_14PX_IMAGE_5_SVG, FIGMA_HEART_FILLED_1_SVG, FIGMA_ICON_HEART_14PX_SIZE_SMALL_STATE_UNLIKED_SVG, FIGMA_ICON_HEART_14PX_SIZE_SMALL_STATE_LIKED_SVG, FIGMA_ICON_HEART_14PX_SIZE_LARGE_STATE_UNLIKED_SVG, FIGMA_ICON_HEART_14PX_SIZE_LARGE_STATE_LIKED_SVG } from './TesttCardd.assets';
...
export const FavouriteButton = ({ className, style, size, state, changeIcon, icon, unlikedIcon, likedIcon, onLikeToggle, onClick }: FavouriteButtonProps) => (
