...
import { FIGMA_IMAGE_CONTAINER_IMAGE_14_SVG, FIGMA_ICON_HEART_14PX_IMAGE_5_SVG, FIGMA_HEART_FILLED_1_SVG } from './DealCard.assets';


export interface DealCard_DeterministicProps {
  className?: string;
  style?: React.CSSProperties;
}

// Deterministic visual assembled from the Figma manifest (exact, no AI).
export const DealCard_Deterministic = ({ className, style }: DealCard_DeterministicProps) => (
...
export default DealCard_Deterministic;
