...
// Minimal semantic button primitive (real <button> + keyboard/focus, no MUI styling) — the
// promotion target for interactive elements whose exact look comes from the Figma-derived sx.
export { default as MuiButtonBase } from '@mui/material/ButtonBase';
...
export { default as MuiInputBase } from '@mui/material/InputBase';
export { default as MuiInputAdornment } from '@mui/material/InputAdornment';
export { default as MuiOutlinedInput } from '@mui/material/OutlinedInput';
