...
import type { FavoriteButtonSize } from './TTT1';
import type { FavoriteButtonState } from './TTT1';
import { FIGMA_ICON_HEART_14PX_IMAGE_5_SVG, FIGMA_HEART_FILLED_1_SVG, FIGMA_ICON_HEART_14PX_SIZE_SMALL_STATE_UNLIKED_SVG, FIGMA_ICON_HEART_14PX_SIZE_SMALL_STATE_LIKED_SVG, FIGMA_ICON_HEART_14PX_SIZE_LARGE_STATE_UNLIKED_SVG, FIGMA_ICON_HEART_14PX_SIZE_LARGE_STATE_LIKED_SVG } from './TTT1.assets';
...
export const FavoriteButton = ({ className, style, size, state, changeIcon, icon, unlikedIcon, likedIcon, onLikeToggle, onClick }: FavoriteButtonProps) => (
